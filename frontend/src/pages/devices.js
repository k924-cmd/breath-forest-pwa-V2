...
import { getDeviceMeta } from '../mocks/devices.js?v=20260808-9';
import { formatObservedAt, getConnectionPresentation, getDeviceStateLabel, getSourceLabel } from '../presentation.js?v=20260808-9';
