...
import { getDeviceMeta } from '../mocks/devices.js?v=20260807-5';
import { formatObservedAt, getConnectionPresentation, getDeviceStateLabel, getSourceLabel } from '../presentation.js?v=20260807-5';
